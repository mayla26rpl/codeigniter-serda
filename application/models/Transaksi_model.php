...
class Transaksi_model extends CI_Model {
	...
	public function cari_obat()
	{
		$data_cart = $this->db->where('obat.nama_obat', $this->input->post('nama_obat'))
							  ->join('kategori', 'kategori.id_kat = obat.id_kat')
							  ->get('obat')
							  ->row();
		if($data_cart != NULL){
	...
	{
		return $this->db->select('obat.nama_obat, kategori.nama_kat, obat.tanggal_kadaluarsa, obat.harga, detil_transaksi.jumlah')
